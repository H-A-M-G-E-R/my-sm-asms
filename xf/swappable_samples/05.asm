...
spcblock 6*!sampleChargingBeam1+!p_instrumentTable nspc
  db !sampleChargingBeam1,$FF,$E0,$00,$02,$81
endspcblock
...
spcblock !p_sample04 nspc
  Sample04: incbin "wide_beam_10512_noloop_a1.5.brr"
  SampleChargingBeam1: incbin "charging_wide_beam_10468.921824_16.brr"
endspcblock
...
.voice0
  ...
  db $F5,0 : !b7
.resumeVoice0
  %make_sound_subnote_with_instr(!sampleChargingBeamCommon, "!c5", 39/64*12, 80, 255)
