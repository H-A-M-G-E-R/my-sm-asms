...
spcblock !p_sample04 nspc
  Sample04: incbin "wave_beam_10512_noloop_a1.5.brr"
  SampleChargingBeam1: incbin "charging_wave_beam_10476.805824_16.brr"
endspcblock
...
.voice0
  ...
  %make_sound_subnote_with_instr(!sampleChargingBeamCommon, "!c5", -47/64*12, 80*92/100, 52)
  db $F5,0 : !b7
.resumeVoice0
  %make_sound_subnote_with_instr(!sampleChargingBeamCommon, "!c5", 51/64*12, 80*92/100, 255)

.voice1
  db $F5,(($A4+51/64*12)-($A4-47/64*12))/52*256 : !b7
  %make_sound_subnote_with_instr(!sampleChargingBeam1, "!c5", -47/64*12, 38*3, 52)
  db $F5,0 : !b7
.resumeVoice1
  %make_sound_subnote_with_instr(!sampleChargingBeam1, "!c5", 51/64*12, 33*3, 255)
