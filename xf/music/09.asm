...
org $A800-$9F80+!p_sampleDataEnd+$400
  Sample18_19_1A_1E: skip filesize("Sample_24f2776ccd9c9315c85798b6b5e78a00.brr")
  Sample1B: skip filesize("Sample_002b224c6729825252e7f39a13633f64.brr")
  Sample1C: skip filesize("Sample_e252324e422454908ea0de0565f41e0d.brr")
  Sample1D: skip filesize("Sample_91eb0ad40cbb8edb59d1a8eb274bb61a.brr")
...
if defined("print_freespace")
  print "Song 09: Space left: $",hex($10000-(2*$800)-pc())
endif
