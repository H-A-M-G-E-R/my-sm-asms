...
pushpc
org $A400-$9F80+!p_sampleDataEnd+$400
  Sample18: skip filesize("Sample_002b224c6729825252e7f39a13633f64.brr")
  Sample19_1A: skip filesize("Sample_588ad9d77b6e7f35ca37ba2344ca43b4.brr")
  Sample1B: skip filesize("Sample_0a8fa0e3956011649dbbdef01c7f5e4b.brr")
  Sample1C: skip filesize("Sample_bbe78ea792aaca4886c0c6c4ebaee1a0.brr")
  Sample1D: skip filesize("Sample_97aa7fd0c57111b1e2e3da056c59f9cf.brr")
...
if defined("print_freespace")
  print "Song 5D: Space left: $",hex($10000-(1*$800)-pc())
endif
