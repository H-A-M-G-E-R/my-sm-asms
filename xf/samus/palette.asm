...
incbin "gfx/Top_Left_UsingAnElevator_Frame0.gfx":0..4*$20
incbin "gfx/Top_Left_UsingAnElevator_Frame0.gfx":$100..$100+2*$20
SamusGfx_Bottom_UsingAnElevator_Frame0:
incbin "gfx/Bottom_UsingAnElevator_Frame0.gfx":0..2*$20
incbin "gfx/Bottom_UsingAnElevator_Frame0.gfx":$100..$100+2*$20
SamusGfx_Top_UsingAnElevator_Frame2:
incbin "gfx/Top_UsingAnElevator_Frame2.gfx":0..6*$20
incbin "gfx/Top_UsingAnElevator_Frame2.gfx":$100..$100+3*$20
SamusGfx_Bottom_UsingAnElevator_Frame2:
incbin "gfx/Bottom_UsingAnElevator_Frame2.gfx":0..3*$20
incbin "gfx/Bottom_UsingAnElevator_Frame2.gfx":$100..$100+3*$20
SamusGfx_Top_Right_UsingAnElevator_Frame0:
incbin "gfx/Top_Right_UsingAnElevator_Frame0.gfx":0..5*$20
incbin "gfx/Top_Right_UsingAnElevator_Frame0.gfx":$100..$100+3*$20
...
; speed booster palette
org $91D9B2
HandleSpeedBoosterScrewAttackPalette:
{
  ; in fusion, speed booster palette takes priority over screw attack palette
  LDA $0B3E : AND #$FF00 : CMP #$0400 :  BEQ .speedBoosting
  LDA $0A1C : DEC : LSR : CMP.w #($81-1)/2 : BNE .normal ; branch if not screw attack pose
  LDA $0A96 : BEQ .startScrewAttack ; branch if anim frame = 0 (start)
  CMP #$001B : BPL .resetPalette ; branch if wall jump eligible

  ; screw attack
  LDX $0A74
  LDA.w .screwAttackPalettePointerPointers,x : CLC : ADC $0ACE : TAX
  LDA $9B0000,x : TAX
  JSR $DD5B
  LDA $0ACE : INC : INC : CMP #$0020 : BMI +
    TDC
  +
  STA $0ACE
.normal
...
.screwAttackPalettePointerPointers
  dw $9BE0,$9C00,$9CE0
...
.speedBoosting
  ...
  +
  LDA #$0004 : STA $0AD0
  LDX $0A74 : LDA.w .speedBoostingPalettePointerPointers,x : CLC : ADC $0ACE : TAX
  LDA $0000,x : TAX
  JSR $DD5B
  LDA $0ACE : INC : INC : CMP #$000E : BMI +
    LDA #$0006
  +
  STA $0ACE
...
.speedBoostingPalettePointerPointers
  dw ..power, ..varia, ..gravity
..power
  dw $9B20,$9B40,$9B60,$9B80,$9B80,$9BC0,$9BC0
..varia
  dw $9D20,$9D40,$9D60,$9D80,$9D80,$9BC0,$9BC0
..gravity
  dw $9F20,$9F40,$9F60,$9F80,$9B80,$9BC0,$9BC0
}
